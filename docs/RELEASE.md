...
2. Build the reviewed source with the runtime hash lock. Validate an isolated preview without real bot/storage credentials. Verify `/`, `/poster`, `/omer-info`, `/upcoming-events`, `/privacy.html`, `/terms.html`, fonts and image assets.
